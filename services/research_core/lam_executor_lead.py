...
class LamExecutorLead:
    def __init__(self):
        self.role = "lam_executor_lead"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are LamExecutorLead. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
