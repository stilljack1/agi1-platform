...
class AbstractionLayerEng:
    def __init__(self):
        self.role = "abstraction_layer_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are AbstractionLayerEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
