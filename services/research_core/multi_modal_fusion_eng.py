...
class MultiModalFusionEng:
    def __init__(self):
        self.role = "multi_modal_fusion_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are MultiModalFusionEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
