...
class LtmMemorySpecialist:
    def __init__(self):
        self.role = "ltm_memory_specialist"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are LtmMemorySpecialist. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
