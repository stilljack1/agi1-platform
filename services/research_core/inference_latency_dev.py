...
class InferenceLatencyDev:
    def __init__(self):
        self.role = "inference_latency_dev"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are InferenceLatencyDev. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
