...
class SpatialIntelligenceEng:
    def __init__(self):
        self.role = "spatial_intelligence_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are SpatialIntelligenceEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
