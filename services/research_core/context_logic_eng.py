...
class ContextLogicEng:
    def __init__(self):
        self.role = "context_logic_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are ContextLogicEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
