...
class CyberneticSecurityEng:
    def __init__(self):
        self.role = "cybernetic_security_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are CyberneticSecurityEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
