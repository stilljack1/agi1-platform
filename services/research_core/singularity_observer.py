...
class SingularityObserver:
    def __init__(self):
        self.role = "singularity_observer"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are SingularityObserver. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
