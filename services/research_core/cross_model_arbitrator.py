...
class CrossModelArbitrator:
    def __init__(self):
        self.role = "cross_model_arbitrator"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are CrossModelArbitrator. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
