...
class VectorSpaceNavigator:
    def __init__(self):
        self.role = "vector_space_navigator"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are VectorSpaceNavigator. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
