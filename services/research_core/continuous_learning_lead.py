...
class ContinuousLearningLead:
    def __init__(self):
        self.role = "continuous_learning_lead"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are ContinuousLearningLead. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
