...
class NeuralInterfaceDev:
    def __init__(self):
        self.role = "neural_interface_dev"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are NeuralInterfaceDev. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
