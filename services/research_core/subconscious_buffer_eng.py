...
class SubconsciousBufferEng:
    def __init__(self):
        self.role = "subconscious_buffer_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are SubconsciousBufferEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
