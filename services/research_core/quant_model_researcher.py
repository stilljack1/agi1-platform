...
class QuantModelResearcher:
    def __init__(self):
        self.role = "quant_model_researcher"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are QuantModelResearcher. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
