...
class EthicalFrameworkEng:
    def __init__(self):
        self.role = "ethical_framework_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are EthicalFrameworkEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
