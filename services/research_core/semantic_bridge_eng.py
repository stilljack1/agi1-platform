...
class SemanticBridgeEng:
    def __init__(self):
        self.role = "semantic_bridge_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are SemanticBridgeEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
