...
class GpuResourceAllocator:
    def __init__(self):
        self.role = "gpu_resource_allocator"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are GpuResourceAllocator. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
