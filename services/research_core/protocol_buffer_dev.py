...
class ProtocolBufferDev:
    def __init__(self):
        self.role = "protocol_buffer_dev"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are ProtocolBufferDev. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
