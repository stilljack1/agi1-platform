...
class RecursionSafetyMonitor:
    def __init__(self):
        self.role = "recursion_safety_monitor"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are RecursionSafetyMonitor. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
