...
class SystemNavigatorDistributor:
    def __init__(self):
        self.role = "system_navigator_distributor"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are SystemNavigatorDistributor. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
...
if __name__ == "__main__":
    agent = SystemNavigatorDistributor()
    try:
