...
class GoalHierarchyLead:
    def __init__(self):
        self.role = "goal_hierarchy_lead"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are GoalHierarchyLead. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
