...
class TokenEfficiencyEng:
    def __init__(self):
        self.role = "token_efficiency_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are TokenEfficiencyEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
