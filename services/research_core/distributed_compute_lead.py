...
class DistributedComputeLead:
    def __init__(self):
        self.role = "distributed_compute_lead"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are DistributedComputeLead. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
