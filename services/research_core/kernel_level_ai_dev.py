...
class KernelLevelAiDev:
    def __init__(self):
        self.role = "kernel_level_ai_dev"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are KernelLevelAiDev. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
