...
class TaskDecompositionEng:
    def __init__(self):
        self.role = "task_decomposition_eng"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are TaskDecompositionEng. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
