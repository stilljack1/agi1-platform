...
class DatasetCuratorAsi:
    def __init__(self):
        self.role = "dataset_curator_asi"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are DatasetCuratorAsi. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
