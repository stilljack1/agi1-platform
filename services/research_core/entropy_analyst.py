...
class EntropyAnalyst:
    def __init__(self):
        self.role = "entropy_analyst"
    ...
    async def run_cycle(self):
        ...
        while True:
            thought = CORTEX.think(
                ...
                context="You are EntropyAnalyst. Mission: Transcend standard AI. Goal: Achieve ASI stability."
            )
